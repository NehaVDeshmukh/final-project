...
public interface Server extends Remote {
	 ...
	 * @return "SUCCESS:..." or "FAILURE:..." to indicate whether the 
     * request upload was successful. ... is an optional customized message
	...
	/**
	 * Returns a reference to a remote PlayerServer implementation. If the
	 *   login is invalid, the result is null.
	 * @param user The username
	 * @param pw The password
	 * @return The PlayerServer, or {@code null} if the login is invalid.
	 * @throws RemoteException
	 */
	public PlayerServer getPlayerServer(String user, String pw) throws RemoteException;

	/**
	 * Returns a reference to a remote AdminServer implementation. If the
	 *   login is invalid, the result is null.
	 * @param user The username
	 * @param pw The password
	 * @return The AdminServer, or {@code null} if the login is invalid.
	 * @throws RemoteException
	 */
	 ...
	 * @param species_id Species ID
	 * @return A pretty-printed representation of the species's program.
	 * @throws RemoteException
	 */
